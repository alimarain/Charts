                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(fontSize: 9, fontWeight: FontWeight.w800, color: Color(0xFF374151)),
                          ),
                        ),
                      ],
                    ),
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final nameField = Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('FULL DISPLAY NAME', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF6B7280), letterSpacing: 0.8)),
              ...
              final emailField = Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('ENTERPRISE EMAIL', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF6B7280), letterSpacing: 0.8)),
                  const SizedBox(height: 6),
                  TextFormField(
              ...
              final deptField = Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('WORK DEPARTMENT', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF6B7280), letterSpacing: 0.8)),
                  const SizedBox(height: 6),
                  TextFormField(
              ...
              final regionField = Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('PRIMARY REGION', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF6B7280), letterSpacing: 0.8)),
                  const SizedBox(height: 6),
