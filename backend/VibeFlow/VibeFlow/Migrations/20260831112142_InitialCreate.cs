    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySalesRecords", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProductInventoryRecords",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInventoryRecords", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodOffsetDays = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationSubmissions_AspNetUsers_SubmittedByUserId",
                        column: x => x.SubmittedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationSubmissions_Forms_FormId",
                        column: x => x.FormId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationSubmissionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationAnswers_ApplicationSubmissions_ApplicationSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationAnswers_ApplicationSubmissionId",
                table: "ApplicationAnswers",
                column: "ApplicationSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSubmissions_FormId",
                table: "ApplicationSubmissions",
                column: "FormId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSubmissions_SubmittedByUserId",
                table: "ApplicationSubmissions",
